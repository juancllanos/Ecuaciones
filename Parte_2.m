...
for i = 1:1:length(t)-1
    ...
    k2x = xp(X(i)+(1/2)*h,Y(i)+(1/2)*h*k1x);
    k2y = yp(X(i)+(1/2)*h,Y(i)+(1/2)*h*k1y);
    
    k3x = xp(X(i)+(1/2)*h,Y(i)+(1/2)*h*k2x);
    k3y = yp(X(i)+(1/2)*h,Y(i)+(1/2)*h*k2y);
    
    k4x = xp(X(i)+h(1),Y(i)+h*k3x);
    k4y = yp(X(i)+h(1),Y(i)+h*k3y);
